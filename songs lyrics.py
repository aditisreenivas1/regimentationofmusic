...
for j in capi_words:
    ...
    #most common words
most_common = Counter(processed_tokens).most_common(20)
    #print("most common words") #bare counts of words
...
display(the_words)
os.makedirs('/Users/aditisreenivas/Downloads/sentiment', exist_ok=True)
the_words.to_csv('/Users/aditisreenivas/Downloads/sentiment/out.csv')
...
plt.show()
    ...
    # Assuming processed_tokens is already defined
...
display(terms_df)
os.makedirs('/Users/aditisreenivas/Downloads/terms', exist_ok=True)
terms_df.to_csv('/Users/aditisreenivas/Downloads/terms/out.csv')
    # Step 4: Train the LDA model
...
lda_model = LdaModel(
    ...
    # Get the LDA representation for the corpus
...
display(topics_df)
os.makedirs('/Users/aditisreenivas/Downloads/topics', exist_ok=True)
topics_df.to_csv('/Users/aditisreenivas/Downloads/topics/out.csv')
